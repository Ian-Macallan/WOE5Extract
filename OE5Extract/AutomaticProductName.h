...
#define PRODUCT_NAME        L"OutlookExtract - Version 2.0.00.002\r\n(Build 47) - (x64 Unicode) (MSVC)\0"
#else
#define ORIGINAL_FILENAME   "OutlookExtract (x64 MBCS) (MSVC)\0"
#define PRODUCT_NAME        "OutlookExtract - Version 2.0.00.002\r\n(Build 47) - (x64 MBCS) (MSVC)\0"
#endif
#elif _WIN32
#ifdef UNICODE
#define ORIGINAL_FILENAME   L"OutlookExtract (x86 Unicode) (MSVC)\0"
#define PRODUCT_NAME        L"OutlookExtract - Version 2.0.00.002\r\n(Build 47) - (x86 Unicode) (MSVC)\0"
#else
#define ORIGINAL_FILENAME   "OutlookExtract (x86 MBCS) (MSVC)\0"
#define PRODUCT_NAME        "OutlookExtract - Version 2.0.00.002\r\n(Build 47) - (x86 MBCS) (MSVC)\0"
#endif
#else
