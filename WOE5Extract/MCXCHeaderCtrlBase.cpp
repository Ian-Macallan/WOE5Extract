...
//
/////////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNAMIC(CMCXCHeaderCtrlBase, CHeaderCtrl)

//
/////////////////////////////////////////////////////////////////////////////
//
/////////////////////////////////////////////////////////////////////////////
CMCXCHeaderCtrlBase::CMCXCHeaderCtrlBase(void)
{
}
...
BEGIN_MESSAGE_MAP(CMCXCHeaderCtrlBase, CHeaderCtrl)
    ON_WM_ERASEBKGND()
    ON_WM_CTLCOLOR()
    ON_NOTIFY_REFLECT(NM_CUSTOMDRAW, &CMCXCHeaderCtrlBase::OnNMCustomdraw)
END_MESSAGE_MAP()
...
//
/////////////////////////////////////////////////////////////////////////////
HBRUSH CMCXCHeaderCtrlBase::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
    //
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL CMCXCHeaderCtrlBase::OnEraseBkgnd(CDC* pDC)
{
    //
...
//
/////////////////////////////////////////////////////////////////////////////
void CMCXCHeaderCtrlBase::OnNMCustomdraw(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//          }
            ...
            case CDDS_ITEMPREPAINT:
            {
                ...
                pDC->SetTextColor ( CMCXColors::GetFGHeaderCR(true) );
                if ( tagHeaderInfo.iImage == 0 )
                {
                    pDC->FillRect ( &rectLabel, CMCXColors::GetBKHeaderCBrush(true) );
