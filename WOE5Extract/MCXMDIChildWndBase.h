...
//
/////////////////////////////////////////////////////////////////////////////
class CMCXMDIChildWndBase : public CMDIChildWnd
{
        DECLARE_DYNCREATE(CMCXMDIChildWndBase)

    public:
        CMCXMDIChildWndBase();   // constructeur standard
        virtual ~CMCXMDIChildWndBase();
