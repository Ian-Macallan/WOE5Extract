...
//
/////////////////////////////////////////////////////////////////////////////
class CMCXDialogExBase : public CDialogEx
{
        DECLARE_DYNAMIC(CMCXDialogExBase)

    public:
        CMCXDialogExBase(UINT nIDTemplate, CWnd* pParent = NULL);   // constructeur standard
        virtual ~CMCXDialogExBase();
