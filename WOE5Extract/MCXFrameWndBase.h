...
//
/////////////////////////////////////////////////////////////////////////////
class CMCXFrameWndBase : public CFrameWnd
{
        DECLARE_DYNCREATE(CMCXFrameWndBase)

    public:
        CMCXFrameWndBase();   // constructeur standard
        virtual ~CMCXFrameWndBase();
    ...
    public:
        ...
        afx_msg LRESULT OnMessageUser1(WPARAM, LPARAM);
